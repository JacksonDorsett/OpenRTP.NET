    ...
    internal class Session
    {
        ...
        private void CalculateTransmissionInterval()
        {
            ...
            if (this._senders <= 0.25 * this._members && this._rtcp_bw != 0)
            {
                ...
                if (this._we_sent)
                {
                    c = this._avg_rtcp_size / (0.25 * this._rtcp_bw);
                    n = this._senders;
                } 
                else
                {
                    c = _avg_rtcp_size / (0.75 * this._rtcp_bw);
            ...
            else if (this._rtcp_bw != 0)
            {
                ...
                c = (double)this._avg_rtcp_size / this._rtcp_bw;
                n = this._members;
            }
            else
            {
            ...
            var deterministicCalculatedInterval = Math.Max(minimumTime, n*c);
